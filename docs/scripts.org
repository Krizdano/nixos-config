...
* Nix Helpers
This is a simple script to simplify the usage of various nix commands. This script currently
provides a convenient way to run various nix commands with a shorter syntax.
